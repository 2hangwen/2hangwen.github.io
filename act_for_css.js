  function add_div_for_body(n){
   ...
   function create_menu_bycss(){
       ...
       $("div#menu").append("<span> <div id=ds ><b style=position:absolute;text-align:center > 留言</b> </div></span>");
       ...
       $("div#menu").append("<span><div id=life ><b style=position:absolute;text-align:center > 日志</b> </div></span><br/> "); 
